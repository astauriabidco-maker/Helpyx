...
import { 
  ...
  Eye, EyeOff, Key, Zap, ArrowRight, ExternalLink
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 p-6">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Pages de test</CardTitle>
            <CardDescription>
              Liens rapides vers les différentes pages de test
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              ...
              <Button 
                onClick={() => window.location.href = '/auth/signin/unified-page'} 
                variant="outline"
                className="justify-start"
              >
                <ExternalLink className="w-4 h-4 mr-2" />
                Page Connexion Avancée
              </Button>
            </div>
          </CardContent>
        </Card>
